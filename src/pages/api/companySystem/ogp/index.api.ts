...
const FONT_BLACK = path.resolve("./fonts/NotoSansJP-Black.otf")
const FONT_MEDIUM = path.resolve("./fonts/NotoSansJP-Medium.otf")
const FONT_REGULAR = path.resolve("./fonts/NotoSansJP-Regular.otf")
